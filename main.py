...
def generate_members():
    ...
    try:
        money = balance()
        ctypes.windll.kernel32.SetConsoleTitleW(f'Generated ~ {generated} | Solved ~ {cap_solved} | Errors ~ {errors} | Proxy Error ~ {proxy_error} | made by .gg/lostnet')
...
\t\t _        _______  _______ _________ _        _______ _________
...
\t\t | |      | |   | |      ) |   | |   | | \   || (         | |   
\t\t | (____/\| (___) |/\____) |   | |   | )  \  || (____/\   | |   
\t\t (_______/(_______)\_______)   )_(   |/    )_)(_______/   )_(   
